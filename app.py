...
if uploaded_file := st.sidebar.file_uploader("Upload SalesData.csv", type=['csv']):
    ...
    # =================================================================
    # 🤖 TAB 5: STRATEGIC AI ADVISOR (完全体：联网 BP + 情境感知 + 一键清空)
    # =================================================================
    with tab5:
                ...
                with st.chat_message("assistant"):
                    ...
                    with st.spinner("💡 Finance BP 正在思考..."):
                        ...
                        insights = generate_weekly_diagnostics(
                            ...
                            matrix_summary_str=bp_data_str, 
                            search_intel_str=live_intel,     
                            chat_history=st.session_state.messages[:-1], 
                            current_prompt=bp_prompt         
                        )
